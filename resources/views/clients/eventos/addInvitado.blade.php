...
<div class="card">
  ...
  <div class="card-body">
    ...
    <form action={{route('addAsist', $eventoId)}} method="post">
        @csrf
                ...
                <tbody id="lista">
                    <div class="input-group mb-3 row">
                        <tr class="fila">
                            <td scope="col">
                                <select class="form-select" name="TipoDocumento">
                                    ...
                                    @foreach($Tipos_documento as $documento)
                                        @if($documento->id == old('TipoDocumento'))
                            ...
                            <td scope="col">
                                <input type="number" name="Documento" id="" class="form-control" value="{{old('Documento')}}">
                            </td>
                            <td scope="col">
        ...
        <div class="d-flex justify-content-between">
            <a href={{route('invitados.index', $eventoId)}} class="btn btn-primary">Regresar</a>
