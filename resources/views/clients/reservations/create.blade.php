...
<div class="text-center">
    ...
    @php
        $nueva_fecha_minima=date("Y-m-d",strtotime($fecha_minima));
        $fecha_maxima=date("d-m-Y",strtotime($fecha_minima."+ 30 days")); 
    @endphp
    ...
    <form action="{{route("reservations.store")}}" method="post">
        ...
        <div class="card" style="overflow-x: auto;">
                ...
                <div>
                    ...
                    <div class="row p-2 section-reservation">
                        ...
                        <div class="col-6">
                            ...
                            <input type="date" name="fecha_ingreso" id="fecha_ingreso" class="form-control" required min="{{$nueva_fecha_minima}}" max="{{$fecha_maxima}}">
                        </div>
                        ...
                        <div class="col-6">
                            ...
                            <input type="date" name="fecha_salida" id="fecha_salida" class="form-control"  min="{{$nueva_fecha_minima}}" max="{{$fecha_maxima}}" required>
                        </div> 
            ...
            <div class="card-footer text-muted">
                ...
                <a class="btn btn-danger" href="{{route("reservations.index")}}" role="button">Cancelar Reserva</a>
